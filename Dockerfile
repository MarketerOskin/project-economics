...
# Bundle the seed to a single self-contained ESM file so the runner needs no TS toolchain.
...
# Prisma CLI + engines + schema/migrations for `migrate deploy` at boot
