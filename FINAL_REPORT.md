...
Отчёт по форме ТЗ §78. Проект — `/Users/vasilijoskin/Documents/project-economics`,
ветка `main`, 34 логических коммита.
...
**Технически:** PostgreSQL, `prisma migrate` + миграция `init`, seed (6 проектов всех
...
32 файла, **186 unit/integration + 2 E2E**.
...
npm test            → Test Files 32 passed (32) · Tests 186 passed (186)
